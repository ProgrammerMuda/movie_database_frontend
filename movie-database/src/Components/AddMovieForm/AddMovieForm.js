        ...
        <div className={styles.form__right}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className={styles.form__group}>
              ...
              <input onChange={handleChange} id="poster" className={styles.form__input} name="poster" type="text" value={poster} />
            ...
            <div className={styles.form__group}>
              ...
              <select id="type" className={styles.form__select} name="type" value={type} onChange={handleChange}>
